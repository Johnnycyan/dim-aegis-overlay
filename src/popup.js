...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateUI() {
        chrome.storage.local.get(['wishlistUrl', 'lastUpdated', 'parsedCount', 'syncStatus', 'syncError', 'scoringSource', 'lightggData', 'lightggLastSync', 'aegisLayoutSide', 'aegisDbMode'], (res) => {
            // Set URL input
